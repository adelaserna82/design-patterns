...
public class Client {
	...
	public static void main(String[] args) {
		...
		Cylinder cylinder1 = new Cylinder(5, "Cylinder 1");
		Cylinder cylinder2 = new Cylinder(5, "Cylinder 2");

		if(hole.fits(cylinder1) == true) {
			System.out.print("El " + cylinder1.getName()  + " cabe en el agujero");
		} else {
			System.out.print("El " + cylinder1.getName()  + " no cabe en el agujero");
		}
